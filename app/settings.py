...
#ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'cornelius.db.elephantsql.com', 'db-project-y8ub.onrender.com']
...
DATABASES = {
    "default": {
        ...
        "NAME": "ecleycsl",  # Update the database name
        "USER": "ecleycsl",  # Update the username
